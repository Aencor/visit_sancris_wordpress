...
/***/ "./wp-content/themes/kikemonk/assets/js/hero.js":
/*!******************************************************!*\
  !*** ./wp-content/themes/kikemonk/assets/js/hero.js ***!
  \******************************************************/
...
var Hero = {
  init: function init() {
    ...
    document.querySelectorAll('.hero-block').forEach(function (block) {
...
/***/ "./wp-content/themes/kikemonk/assets/js/logo-grid.js":
/*!***********************************************************!*\
  !*** ./wp-content/themes/kikemonk/assets/js/logo-grid.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var LogoGrid = {
  init: function init() {
    ...
    document.querySelectorAll('.logo-grid-block').forEach(function (block) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (LogoGrid);
...
/* harmony import */ var _scss_style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../scss/style.scss */ "./wp-content/themes/kikemonk/assets/scss/style.scss");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _hero__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../hero */ "./wp-content/themes/kikemonk/assets/js/hero.js");
/* harmony import */ var _logo_grid__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../logo-grid */ "./wp-content/themes/kikemonk/assets/js/logo-grid.js");
/* harmony import */ var _side_by_side__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../side-by-side */ "./wp-content/themes/kikemonk/assets/js/side-by-side.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
...
var eventMarkers = [];
var allPlaces = [];
var allEvents = []; // Store events globally
...
var common = {
  init: function init() {
    ...
    _logo_grid__WEBPACK_IMPORTED_MODULE_1__["default"].init();
    _side_by_side__WEBPACK_IMPORTED_MODULE_2__["default"].init();
    $(document).on('click', '#theme-toggle, .theme-toggle-btn', toggleTheme);

    // --- GSAP Animations ---
    var tl = gsap.timeline();
    if ($('#landing-section').length) {
      tl.from("#landing-section img", {
        y: -50,
        opacity: 0,
        duration: 1,
        ease: "power3.out"
      }).from("#landing-section h1", {
        y: 30,
        opacity: 0,
        duration: 0.8
      }, "-=0.5").from("#main-search", {
        scale: 0.8,
        opacity: 0,
        duration: 0.5,
        clearProps: "opacity"
      }, "-=0.3").from("#landing-section p", {
        y: 20,
        opacity: 0,
        duration: 0.5
      }, "-=0.3");
    ...
    $('#main-search').on('keypress', function (e) {
      if (e.which == 13) _this.handleSearch();
    });
    $('#header-search').on('keypress', function (e) {
      if (e.which == 13) {
        var query = $(e.target).val();
        _this.filterPlacesByText(query);
      }
    });
    ...
    $('.category-filter').on('click', function (e) {
      ...
      if (category === 'all') {
        ...
        $('.category-filter').each(function (i, el) {
          var cat = $(el).data('cat');
          var isActive = !$(el).find('.check-icon').hasClass('opacity-0');
          if (cat !== 'all' && isActive) activeCats.push(cat);
        });
        if (activeCats.length === 0) {
          _this.filterPlaces(['all']);
        } else {
          _this.filterPlaces(activeCats);
        }
      }
    });

    // --- Events Toggle ---
    $('#toggle-events-btn').on('click', function (e) {
      var btn = $(e.currentTarget);
      ...
      if (container.hasClass('hidden')) {
        ...
        btn.removeClass('bg-white border-slate-200 text-slate-700 dark:bg-slate-700 dark:text-slate-200').addClass('bg-brand-gold text-white border-transparent');
        _this.renderEventMarkers();
        ...
        _this.clearEventMarkers();
        btn.addClass('bg-white border-slate-200 text-slate-700 dark:bg-slate-700 dark:text-slate-200').removeClass('bg-brand-gold text-white border-transparent');
      }
    });
    $(document).on('click', '.btn-directions', function (e) {
      e.stopPropagation();
      var placeName = $(this).data('name');
      var url = "https://www.google.com/maps/search/?api=1&query=".concat(encodeURIComponent(placeName + " San Cristóbal de las Casas"));
      window.open(url, '_blank');
    });
    $(document).on('click', '.btn-more-info', function (e) {
      e.stopPropagation();
      var id = $(this).data('id');
      var place = allPlaces.find(function (p) {
        return p.id === id;
      });
      if (place && place.url) {
  ...
  fetchWordPressPlaces: function fetchWordPressPlaces() {
    var _this3 = this;
    ...
    $.ajax({
      ...
      method: 'GET',
      success: function success(lugares) {
        console.log('Lugares recibidos:', lugares.length);
        console.log('Primer lugar:', lugares[0]);
        allPlaces = lugares.map(function (lugar) {
          var _lugar$_embedded, _lugar$acf, _lugar$acf2, _lugar$acf3, _lugar$excerpt;
          var featuredImage = ((_lugar$_embedded = lugar._embedded) === null || _lugar$_embedded === void 0 || (_lugar$_embedded = _lugar$_embedded['wp:featuredmedia']) === null || _lugar$_embedded === void 0 || (_lugar$_embedded = _lugar$_embedded[0]) === null || _lugar$_embedded === void 0 ? void 0 : _lugar$_embedded.source_url) || 'https://loremflickr.com/320/240/san-cristobal';
          var ubicacion = (_lugar$acf = lugar.acf) === null || _lugar$acf === void 0 ? void 0 : _lugar$acf.ubicacion;
          return {
            id: lugar.id,
            name: lugar.title.rendered,
            category: ((_lugar$acf2 = lugar.acf) === null || _lugar$acf2 === void 0 ? void 0 : _lugar$acf2.categoria) || 'general',
            lat: parseFloat(ubicacion === null || ubicacion === void 0 ? void 0 : ubicacion.lat) || 16.7371,
            lng: parseFloat(ubicacion === null || ubicacion === void 0 ? void 0 : ubicacion.lng) || -92.6376,
            address: (ubicacion === null || ubicacion === void 0 ? void 0 : ubicacion.address) || '',
            description: ((_lugar$acf3 = lugar.acf) === null || _lugar$acf3 === void 0 ? void 0 : _lugar$acf3.descripcion_personalizada) || ((_lugar$excerpt = lugar.excerpt) === null || _lugar$excerpt === void 0 || (_lugar$excerpt = _lugar$excerpt.rendered) === null || _lugar$excerpt === void 0 ? void 0 : _lugar$excerpt.replace(/<[^>]*>/g, '').substring(0, 100)) || 'Visita este increíble lugar en San Cristóbal.',
            image: featuredImage,
            url: lugar.link
          };
        });
        $("#map-loader").addClass('hidden');
        _this3.renderPlaces(allPlaces);
        _this3.renderEventsList();
      },
      error: function error() {
        ...
        allPlaces = [];
        _this3.renderPlaces(allPlaces);
        _this3.renderEventsList(); // Also render events even if places fail
      }
    });
  },
  ...
  renderPlaces: function renderPlaces(places) {
    ...
    var getIcon = function getIcon(place) {
      var emojis = {
        restaurant: '🍽️',
        park: '🌳',
        museum: '🏛️',
      ...
      var iconChar = place.icon || emojis[place.category] || '📍';
      return L.divIcon({
        className: 'custom-marker',
        html: "<div class=\"flex items-center justify-center w-10 h-10 bg-white dark:bg-slate-800 rounded-full shadow-lg border-2 border-brand-blue text-xl\">".concat(iconChar, "</div>"),
        iconSize: [40, 40],
        iconAnchor: [20, 40],
        popupAnchor: [0, -60]
      });
  ...
  generateMockPlaces: function generateMockPlaces(lat, lng) {
    var count = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 15;
    var categories = ['restaurant', 'park', 'museum', 'shop'];
    var places = [];
    for (var i = 0; i < count; i++) {
      var category = categories[Math.floor(Math.random() * categories.length)];
      places.push({
        id: i,
        name: "Lugar Mock ".concat(category, " ").concat(i + 1),
        category: category,
        lat: lat + (Math.random() - 0.5) * 0.036,
        lng: lng + (Math.random() - 0.5) * 0.036,
        description: "Un lugar excelente para visitar en San Cris.",
        image: "https://loremflickr.com/320/240/".concat(category, ",san-cristobal?random=").concat(i)
      });
    }
    return places;
  },
  filterPlaces: function filterPlaces(categories) {
    if (categories === 'all' || Array.isArray(categories) && categories.includes('all')) {
      ...
      this.renderPlaces(allPlaces.filter(function (p) {
        return cats.includes(p.category);
      }));
    }
  },
  filterPlacesByText: function filterPlacesByText(text) {
    if (!text) return this.renderPlaces(allPlaces);
    var lowerText = text.toLowerCase();
    this.renderPlaces(allPlaces.filter(function (p) {
      return p.name.toLowerCase().includes(lowerText) || p.description.toLowerCase().includes(lowerText);
    }));
  },
  renderEventsList: function renderEventsList() {
    var container = $('#events-container');
    container.empty().append('<h3 class="text-3xl font-black text-brand-gold italic">HOY</h3>');
    var renderEvents = function renderEvents(eventos) {
      if (!eventos || eventos.length === 0) {
        container.append('<p class="text-slate-400 text-sm mt-4">No hay eventos próximos</p>');
        return;
      }
      eventos.forEach(function (evento, index) {
        var _evento$acf, _evento$acf2, _evento$acf3;
        var fecha = ((_evento$acf = evento.acf) === null || _evento$acf === void 0 ? void 0 : _evento$acf.fecha) || 'Próximamente';
        var hora = ((_evento$acf2 = evento.acf) === null || _evento$acf2 === void 0 ? void 0 : _evento$acf2.hora) || '';
        var ubicacion = ((_evento$acf3 = evento.acf) === null || _evento$acf3 === void 0 ? void 0 : _evento$acf3.ubicacion) || '';
        var datetime = hora ? "".concat(fecha, ", ").concat(hora) : fecha;
        var title = evento.title.rendered || evento.title; // Handle both API and localized format
        var link = evento.link || '#';
        var card = $("\n          <div class=\"bg-white/95 dark:bg-slate-800/95 p-3 rounded-xl shadow-xl opacity-0 cursor-pointer hover:scale-105 transition-transform\" data-url=\"".concat(link, "\">\n            <h4 class=\"font-bold text-brand-blue dark:text-white text-sm truncate\">").concat(title, "</h4>\n            <p class=\"text-[10px] text-slate-500\">").concat(datetime, " \u2022 ").concat(ubicacion, "</p>\n          </div>\n        "));
    ...
    $.ajax({
      ...
      method: 'GET',
      success: function success(eventos) {
  ...
  renderEventMarkers: function renderEventMarkers() {
    if (!allEvents || allEvents.length === 0) return;
    var getEventIcon = function getEventIcon() {
      return L.divIcon({
  ...
  clearEventMarkers: function clearEventMarkers() {
...
/***/ "./wp-content/themes/kikemonk/assets/js/side-by-side.js":
/*!**************************************************************!*\
  !*** ./wp-content/themes/kikemonk/assets/js/side-by-side.js ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var SideBySide = {
  init: function init() {
    ...
    document.querySelectorAll('.side-by-side-block').forEach(function (block) {
